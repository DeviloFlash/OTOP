...
<body class="hold-transition sidebar-mini sidebar-collapse layout-fixed layout-navbar-fixed">
  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <div class="content-header" style="padding:0px;" height="200">
        <div class="position-relative " style="min-height:200px; object-fit:cover;">
          <img src="<?php echo base_url(); ?>assest/dist/img/bg-main.png" class="card-img position-absolute" style="object-fit:cover;" height="200" alt="...">
          <div class="row">
            <div class="col-md-2 col-6">
              <img src="<?php echo base_url(); ?>assest/dist/img/avatar5.png" class="img-circle bg-white img-fluid p-2 m-2 elevation-2" style="object-fit:cover; width:190px; height:190px;">
            </div>
            <div class="col-md-10 col-6 p-3 text-white" style="text-shadow: 0 0 3px #000;">
              <h2><?php echo $readshowsell->display_name; ?></h2>
              <h4><?php echo $readshowsell->mobile_number; ?></h4>
              <p><?php echo $readshowsell->address; ?></p>
            </div>
          </div>
        </div>
      </div><!-- /.content-header -->
            ...
            <div class="row">
              ...
              <?php if (isset($_SESSION['buyer_id']) && $_SESSION['display_name_buy'] != "") { ?>
                ...
                if ($showlike == NULL) { ?>
                  ...
                  <form action="<?php echo base_url(); ?>Store/addlike" method="post">
                    <?php if (isset($_SESSION['buyer_id']) && $_SESSION['display_name_buy'] != "") { ?>
                      <input type="hidden" name="buyer_id" value="<?php echo $_SESSION['buyer_id'] ?>">
                    <?php } else { ?>
                    <?php } ?>
                    <input type="hidden" name="user_id" value="<?php echo $readshowsell->user_id; ?>">
                    <button class="ml-2 btn btn-success" type="submit"><i class="far fa-thumbs-up mr-1"></i>ถูกใจ (<?php echo count($countlike); ?>)</button>
                  </form>

                  <?php } else {
                  foreach ($showlike as $show) { ?>
                    <form action="<?php echo base_url('Store/dellike/') . $show->id_like; ?>" method="post">
                      <input type="hidden" name="user_id" value="<?php echo $show->user_id; ?>">
                      <input type="hidden" name="buyer_id" value="<?php echo $show->buyer_id; ?>">
                      <button class="ml-2 btn btn-danger" type="submit"><i class="far fa-thumbs-down mr-1"></i>ยกเลิกถูกใจ (<?php echo count($countlike); ?>)</button>
                    </form>
                  <?php } ?>
                <?php } ?>
      ...
      <?php } else { ?>
        <a class="ml-2 btn btn-success" href="<?php echo base_url() ?>Login2/member"><i class="far fa-thumbs-up mr-1"></i>ถูกใจ (<?php echo count($countlike); ?>)</a>
      <?php } ?>
                ...
                <a href="<?php echo base_url('Product/Product_view/') . $show->id_product; ?>">
                  <div class="card bg-white rounded-lg elevation-4" data-aos="zoom-in" style="width: 100%;">
                    ...
                    <div class="card-body">
                      ...
                      <p class="card-text">จำนวน <?php echo $show->number; ?> ชิ้น</p>
                    </div>
                  </div>
                </a>
              </div><!-- ส่วนกล่องสินค้า -->
