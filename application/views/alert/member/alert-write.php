...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
        <div class="col-md-3">
        <a href="" class="btn btn-warning btn-block mb-3"><span class="text-white">รายงานสินค้า</span></a>
        ...
        <div class="col-md-9">
          <div class="card card-warning card-outline">
            ...
            <form action="<?php echo base_url(); ?>Member/addreport" method="post">
            <input type="hidden" name="buyer_id" value="<?php echo $_SESSION['buyer_id'] ?>">
            <!-- /.card-header -->
            <div class="card-body">
              <div class="form-group">
                <input class="form-control" name="topic_report" placeholder="หัวข้อ :">
              </div>
              <div class="form-group">
                <input class="form-control"  name="user_id" placeholder="ถึง :">
              </div>
              <div class="form-group">
                  <textarea id="compose-textarea"  name="detel_report" class="form-control" style="height: 300px">
                    เขียน...
                  </textarea>
              </div>
            </div>
