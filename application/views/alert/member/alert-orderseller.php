...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <?php if (isset($_SESSION['buyer_id']) && $_SESSION['display_name'] != "") { ?>
        <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="<?php echo base_url(); ?>Member" class="d-block"><?php echo $buyer->display_name ;?> (ผู้ซื้อ)</a>
        </div>
      </div>
      <?php } else { ?>
    <div class="sidebar">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
        <div class="col-md-3">
          <a href="<?php echo base_url() ?>Member/Alertwrit" class="btn btn-warning btn-block mb-3"><span class="text-white">เขียน</span></a>
          ...
          <div class="card card-warning card-outline">
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                <tr>
                  <td><a href="<?php echo base_url() ?>Member/Alert">เเจ้งเตือน</a></td>
                  <td>ไข่เเดง</td>
                  <td>12/04/2020</td>
                </tr>
                <tr>
