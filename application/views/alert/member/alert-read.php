      ...
      <div class="row">
        ...
        <div class="col-md-9">
          <div class="card card-warning card-outline">
            <div class="card-header">
              <h3 class="card-title"><?php echo $readshowalert->topic; ?></h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body p-0">
              <div class="mailbox-read-info">
                <h5><?php echo $readshowalert->topic; ?></h5>
                <h6>จาก : ผู้ขาย <?php echo $readshowalert->display_name; ?>
                  <span class="mailbox-read-time float-right"><?php echo $readshowalert->data_alert; ?></span></h6>
              </div>
              <div class="mailbox-read-message">
                <p>สวัสดีคุณ <?php echo $readshowalert->first_name_buy; ?></p>

                <p> หมายเลขใบเสร็จของคุณคือ <?php echo $readshowalert->product_number; ?></p>
