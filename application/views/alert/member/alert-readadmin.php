  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h1>เเจ้งเตือนจากผู้ดูเเลระบบ</h1>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
      ...
      <div class="row">
        ...
        <div class="col-md-9">
          <div class="card card-warning card-outline">
            <div class="card-header">
              <h3 class="card-title"><?php echo $readshowalertadmin_buy->topic_buy; ?></h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body p-0">
              <div class="mailbox-read-info">
                <h5><?php echo $readshowalertadmin_buy->topic_buy; ?></h5>
                <h6>จาก : ผู้ดูเเลระบบ <?php echo $readshowalertadmin_buy->display_name_admin; ?>
                  <span class="mailbox-read-time float-right"><?php echo $readshowalertadmin_buy->data_alert_buy; ?></span></h6>
              </div>
              <div class="mailbox-read-message">
                <p>สวัสดีคุณ <?php echo $readshowalertadmin_buy->first_name_buy; ?></p>

                <p><?php echo $readshowalertadmin_buy->detel_buy; ?></p>
