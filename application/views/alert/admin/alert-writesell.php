...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <form action="<?php echo base_url(); ?>Admin/addalertuser" method="post">
          ...
          <div class="card card-primary card-outline">
            ...
            <div class="card-body">
              <div class="form-group">
                <input class="form-control" name="topic_alert_user" placeholder="หัวข้อ :">
              </div>
              <div class="form-group">
                <input class="form-control" placeholder="<?php echo $readshowselladmin->display_name;?>" disabled>
              </div>
              <div class="form-group">
                  <textarea id="compose-textarea" name="detel_alert_user" class="form-control" style="height: 300px">
                    เขียน...
                  </textarea>
              </div>
            </div>
