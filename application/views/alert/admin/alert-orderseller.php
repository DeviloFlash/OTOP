            ...
            <div class="card card-primary card-outline">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <?php $i = 1; foreach ($showreportselladmin as $showreportsell) { ?>
                      <tr>
                        <td><?php echo $i++; ?></td>
                        <td><a href="<?php echo base_url('Admin/Alertreadsell/') . $showreportsell->id_report_user ?>"><?php echo $showreportsell->topic_report_user; ?></a></td>
                        <td><?php echo $showreportsell->display_name; ?></td>
                        <td><?php echo $showreportsell->data_report_user; ?></td>
                      </tr>
                    <?php } ?>
