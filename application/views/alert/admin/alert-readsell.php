      ...
      <div class="row">
        ...
        <div class="col-md-9">
          <div class="card card-primary card-outline">
            <div class="card-header">
              <h3 class="card-title"><?php echo $readshowreportselladmin->topic_report_user; ?></h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body p-0">
              <div class="mailbox-read-info">
                <h5><?php echo $readshowreportselladmin->topic_report_user; ?></h5>
                <h6>จาก : ผู้ขาย <?php echo $readshowreportselladmin->display_name; ?>
                  <span class="mailbox-read-time float-right"><?php echo $readshowreportselladmin->data_report_user; ?></span></h6>
              </div>
              <div class="mailbox-read-message">
                <p>สวัสดีคุณ <?php echo $readshowreportselladmin->display_name_admin; ?></p>

                <p><?php echo $readshowreportselladmin->detel_report_user; ?></p>
