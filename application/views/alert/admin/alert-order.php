              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <?php $i = 1;
                    foreach ($showreportmemberadmin as $showreportmember) { ?>
                      <tr>
                        <td><?php echo $i++; ?></td>
                        <td><a href="<?php echo base_url('Admin/Alertread/') . $showreportmember->id_report_buyer ?>"><?php echo $showreportmember->topic_report_buyer; ?></a></td>
                        <td><?php echo $showreportmember->display_name_buy; ?></td>
                        <td><?php echo $showreportmember->data_report_buyer; ?></td>
                      </tr>
