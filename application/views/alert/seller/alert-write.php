      ...
      <div class="row">
        ...
        <div class="col-md-9">
          <div class="card card-info card-outline">
            ...
            <form action="<?php echo base_url(); ?>Dashboard/addalertreport" method="post">
            <input type="hidden" name="user_id" value="<?php echo $_SESSION['user_id'] ?>">
            <!-- /.card-header -->
            <div class="card-body">
              <div class="form-group">
                <input class="form-control" name="topic" placeholder="หัวข้อ :">
              </div>
              <div class="form-group">
                <input class="form-control"  name="buyer_id" placeholder="ถึง :">
              </div>
              <div class="form-group">
