            ...
            <div class="card card-info card-outline">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <?php $i = 1; foreach ($showreport as $showreportbuy) { ?>
                      <tr>
                        <td><a href="<?php echo base_url('Dashboard/Alert/') . $showreportbuy->id_report; ?>"><?php echo $showreportbuy->topic_report; ?></a></td>
                        <td><?php echo $showreportbuy->display_name_buy; ?></td>
                        <td><?php echo $showreportbuy->data_report; ?></td>
                      </tr>
                    <?php } ?>
