...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <form action="<?php echo base_url(); ?>Dashboard/addalert" method="post">
    <!-- Main content -->
    <section class="content">
    <input type="hidden" name="user_id" value="<?php echo $_SESSION['user_id'] ?>">
    <input type="hidden" name="buyer_id" value="<?php echo $readbillotop->buyer_id;?>">
      <div class="col-md-12">
        <div class="card card-info card-outline">
          ...
          <div class="card-body">
            <div class="form-group">
              <input class="form-control" name="topic" placeholder="ส่งรหัสสินค้า" value="ส่งรหัสสินค้า">
            </div>
            <div class="form-group">
              <input class="form-control"  placeholder="<?php echo $readbillotop->first_name_buy;?>" disabled>
            </div>
            <div class="form-group">
                <textarea id="compose-textarea" name="product_number" class="form-control" style="height: 300px">
                  เขียน...
                </textarea>
            </div>
          </div>
