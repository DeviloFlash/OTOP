  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h1>เเจ้งเตือนถึงผู้ดูเเลระบบ</h1>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
      ...
      <div class="row">
        ...
        <div class="col-md-9">
          <div class="card card-info card-outline">
            ...
            <form action="<?php echo base_url(); ?>Dashboard/addreportuser" method="post">
            <input type="hidden" name="user_id" value="<?php echo $_SESSION['user_id'] ?>">
            <!-- /.card-header -->
            <div class="card-body">
              <div class="form-group">
                <input class="form-control" name="topic_report_user" placeholder="หัวข้อ :">
              </div>
              <div class="form-group">
                <input class="form-control"  name="admin_id" placeholder="ถึง :">
              </div>
              <div class="form-group">
                  <textarea id="compose-textarea" name="detel_report_user" class="form-control" style="height: 300px">
                    เขียน...
                  </textarea>
              </div>
            </div>
