      ...
      <div class="row">
        ...
        <div class="col-md-9">
          <div class="card card-info card-outline">
            <div class="card-header">
              <h3 class="card-title"><?php echo $readshowalertadmin_user->topic_alert_user; ?></h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body p-0">
              <div class="mailbox-read-info">
                <h5><?php echo $readshowalertadmin_user->topic_alert_user; ?></h5>
                <h6>จาก : <?php echo $readshowalertadmin_user->display_name_admin; ?>
                  <span class="mailbox-read-time float-right"><?php echo $readshowalertadmin_user->data_alert_user; ?></span></h6>
              </div>
              <div class="mailbox-read-message">
                <p>สวัสดีคุณ <?php echo $readshowalertadmin_user->display_name; ?></p>

                <p><?php echo $readshowalertadmin_user->detel_alert_user; ?></p>
