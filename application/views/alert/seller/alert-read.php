      ...
      <div class="row">
        ...
        <div class="col-md-9">
          <div class="card card-info card-outline">
            <div class="card-header">
              <h3 class="card-title"><?php echo $readshowreport->topic_report; ?></h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body p-0">
              <div class="mailbox-read-info">
                <h5><?php echo $readshowreport->topic_report; ?></h5>
                <h6>จาก : <?php echo $readshowreport->display_name_buy; ?>
                  <span class="mailbox-read-time float-right"><?php echo $readshowreport->data_report; ?></span></h6>
              </div>
              <div class="mailbox-read-message">
                <p>สวัสดีคุณ <?php echo $readshowreport->display_name; ?></p>

                <p><?php echo $readshowreport->detel_report; ?></p>
