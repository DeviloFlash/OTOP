                  ...
                  <tbody>
                    ...
                    <?php $i=1; foreach ($showmemberadmin as $showmember) { ?>
                      ...
                      <th><?php echo $i++; ?></th>
                        ...
                        <td>
                          <div class="btn-group">
                            <a href="<?php echo base_url('Admin/Alertwritbuy/') . $showmember->buyer_id ?>"><button type="submit" class="btn btn-warning"><i class="fas fa-paper-plane"></i></button></a>
                          </div>
                        </td>
                      </tr>
                      <tr>
