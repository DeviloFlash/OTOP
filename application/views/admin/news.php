...
<body class="hold-transition sidebar-mini sidebar-collapse layout-fixed layout-navbar-fixed">
  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-12">
              <div class="row">
                <h1>ข่าวสาร</h1>
                <a href="<?php echo base_url(); ?>Admin/Addnews" class="btn btn-success ml-2"><i class="fas fa-plus mr-1"></i>เพิ่มข่าวสาร</a>
              </div>
            </div>
          </div>
        </div><!-- /.container-fluid -->
      ...
      <!-- <?php foreach ($shownews as $shownewsadmin) { ?>
                <div class="carousel-item">
                  <a href="#">
                    <img src="<?php echo base_url('assest/img/otop')?>/<?php echo $shownewsadmin->img_otop; ?>" class="d-block " alt="..." style="width: 100%;">
                  </a>
                </div>
                <?php } ?> -->
        ...
        <div class="col-12 col-md-7">
            <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
              <div class="carousel-inner">
                ...
                <div class="carousel-item">
                  <a href="#">
                    <img src="<?php echo base_url('assest/img/otop')?>/<?php echo $shownewsadmin->img_news; ?>" class="d-block " alt="..." style="width: 100%;">
                  </a>
                </div>
                <?php } ?>
        ...
        <div class="col-12 col-md-7">
          ...
          <div class="card">
            <div class="card-header border-transparent">
              <h3 class="card-title">ตารางข่าว</h3>
            ...
            <div class="card-body p-2">
              <div class="table-responsive">
                <table id="example2" class="table table-bordered table-striped">
                  ...
                  <tr>
                  <?php foreach ($shownews as $shownewsadmin) { ?>
                    <td><a href="<?php echo base_url('Admin/NewsView/').$shownewsadmin->id_news; ?>"><?php echo $shownewsadmin->topic_news;?></a></td>
                    <td><?php echo $shownewsadmin->data_news;?></td>
                    <td><a href="<?php echo base_url('Admin/delnews/') .$shownewsadmin->id_news; ?>" type="button" class="btn btn-danger"><i class="fas fa-times"></i></a></td>
                  <?php } ?>
                  </tr>
                  </tbody>
                </table>
