...
<body class="hold-transition sidebar-mini sidebar-collapse layout-fixed layout-navbar-fixed">
 ...
 <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="content-wrapper">
      ...
      <form action="<?php echo base_url('Admin/addnewsadmin'); ?>" method="post" enctype="multipart/form-data">
      <!-- Main content -->
            ...
            <div class="card-body p-3">
              ...
              <div class="form-group">
                ...
                <div class="custom-file overflow-hidden">
                  <input type="file" name="img_news" class="custom-file-input"  accept="image/*">
                  <label class="custom-file-label" for="customFile">เพิ่มรูป</label>
                </div>
              </div>
              <div class="form-group">
                <input class="form-control" name="topic_news" placeholder="หัวเรื่องข่าวสาร">
              </div>
              <!-- /.table-responsive -->
              <p>รายละเอียดข่าวสาร</p>
              <div class="form-group">
                  <textarea id="compose-textarea" name="detel_news" class="form-control" style="height: 300px">
                    เขียน...
                  </textarea>
              </div>

              <div class="d-flex flex-row-reverse bd-highlight">
                <button type="submit" class="btn btn-success bd-highlight"><i class="far fa-credit-card mr-2"></i>บันทึก</button>
              </div>
            </div>
          </div>
          <!-- /.card -->
