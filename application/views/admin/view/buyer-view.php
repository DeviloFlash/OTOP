    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-12">
                <h3>ID : <?php echo $readshowmemberadmin->buyer_id; ?></h3>
            </div>
          </div>
        </div><!-- /.container-fluid -->
      </section>
          ...
          <div class="col-md-3 col-12">
            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                ...
                <h3 class="profile-username text-center"><?php echo $readshowmemberadmin->display_name_buy; ?></h3>

                <p class="text-muted text-center">ID : <?php echo $readshowmemberadmin->buyer_id; ?></p>

             

               
                <?php
                $blockbuyer = $readshowmemberadmin->buyer_role;
                if (empty($blockbuyer) == 0) { ?>
                <form action="<?php echo base_url(); ?>Admin/addblockbuyer" method="post">
                <input type="hidden" name="buyer_id" value="<?php echo $readshowmemberadmin->buyer_id; ?>">
                <input type="hidden" name="buyer_role" value="0" value="<?php echo $readshowmemberadmin->buyer_role; ?>">
                ...
                <?php } elseif (empty($blockbuyer) == 3) { ?>
                  <form action="<?php echo base_url(); ?>Admin/addblockbuyer" method="post">
                  <input type="hidden" name="buyer_id" value="<?php echo $readshowmemberadmin->buyer_id; ?>">
                <input type="hidden" name="buyer_role" value="3" value="<?php echo $readshowmemberadmin->buyer_role; ?>">
          ...
          <div class="col-md-4 col-12">
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <p><?php echo $readshowmemberadmin->address_buy; ?></p>
                <p><i class="fas fa-phone-volume mr-2"></i>เบอร์โทร</p>
                <p><?php echo $readshowmemberadmin->mobile_number_buy; ?></p>
                <p><i class="fas fa-at mr-2"></i>อีเมล</p>
                <p><?php echo $readshowmemberadmin->email; ?></p>
              </div><!-- /.card-body -->
            </div>
            <!-- /.nav-tabs-custom -->
                    ...
                    <div class="card-body p-2">
                      <div class="table-responsive">
                        <table id="example1" class="table table-bordered table-striped">
                          ...
                          <?php foreach ($showbillmemberadmin as $showbillmember) { ?>
                          <tr>
                            <td><a href="<?php echo base_url('Admin/BillView/').$showbillmember->id_billotop ?>"><?php echo $showbillmember->id_billotop; ?></a></td>
