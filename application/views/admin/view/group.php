...
<body class="hold-transition sidebar-mini sidebar-collapse layout-fixed layout-navbar-fixed">
  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <form action="<?php echo base_url('Admin/addgrop'); ?>" method="post">
          ...
          <div class="card">
            ...
            <div class="card-body p-3">
              ...
              <div class="form-group">
                <div class="row">
                  <input type="text" class="form-control col-6" name="grop_logo_img" placeholder="กรอกข้อมูล">
                  <a href="https://fontawesome.com/icons" class="btn btn-primary ml-2">Font Awesome</a>
                </div>
              </div>
              <!-- /.table-responsive -->
              <p>ชื่อหมวดหมู่</p>
              <div class="form-group">
                <input type="text" class="form-control col-12" name="grop_name" placeholder="ชื่อ..">
              </div>
