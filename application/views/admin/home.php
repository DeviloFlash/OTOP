...
<body class="hold-transition sidebar-mini sidebar-collapse layout-fixed layout-navbar-fixed">
  ...
  <div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-light" style="background:	#605ca8;">
      ...
      <!-- SEARCH FORM -->
      <form class="form-inline ml-3 elevation-1" action="<?php echo base_url(); ?>Admin" method="post">
    ...
    <div class="content-wrapper">
        ...
        <div class="row">
          <div class="col-md-3 col-sm-6 col-6">
            <div class="info-box">
              ...
              <div class="info-box-content">
                <span class="info-box-text">ผู้ซื้อ</span>
                <span class="info-box-number"><?php echo count($showmemberadmin);?></span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
          ...
          <div class="col-md-3 col-sm-6 col-6">
            <div class="info-box">
              ...
              <div class="info-box-content">
                <span class="info-box-text">ผู้ขาย</span>
                <span class="info-box-number"><?php echo count($showselladmin);?></span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
          ...
          <div class="col-md-3 col-sm-6 col-6">
            <div class="info-box">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number"><?php echo count($showproductadmin);?></span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
          ...
          <div class="col-md-3 col-sm-6 col-6">
            <div class="info-box">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number">ผู้ซื้อ <?php echo count($showreportselladmin);?> || ผู้ขาย <?php echo count($showreportmemberadmin);?></span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
          ...
          <div class="col-md-6 col-12">
            ...
            <div class="card">
              <div class="card-header border-transparent">
                <h3 class="card-title"><i class="fas fa-store mr-2"></i>ผู้ขาย</h3>
              ...
              <div class="card-body p-1">
                <div class="table-responsive">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <?php $i=1; foreach ($showselladmin as $showadminsell) { ?>
                    <tr>
                      <th><?php echo $showadminsell->user_id; ?></th>
                      <td><a href="<?php echo base_url('Admin/SellerView/').$showadminsell->user_id ?>"><?php echo $showadminsell->display_name; ?></a></td>
                      <td><?php echo $showadminsell->created_date; ?></td>

                      <?php
                        $block = $showadminsell->user_role;
                        if (empty($block) == 0) { ?>
                          <td><span class="badge badge-success">ปกติ</span></td>
                        <?php } elseif (empty($block) == 2) { ?>
              ...
              <div class="card-body p-1">
                <div class="table-responsive">
                  <table id="example2" class="table table-bordered table-striped">
                    ...
                    <tbody>
                    <?php $i=1; foreach ($showmemberadmin as $showmember) { ?>
                      <tr>
                      <th><?php echo $showmember->buyer_id; ?></th>
                      <td><a href="<?php echo base_url('Admin/UserView/').$showmember->buyer_id ?>"><?php echo $showmember->display_name_buy; ?></a></td>
                      <td><?php echo $showmember->data; ?></td>
                      <?php
                        $blockbuyer = $showmember->buyer_role;
                        if (empty($blockbuyer) == 0) { ?>
                          <td><span class="badge badge-success">ปกติ</span></td>
                        <?php } elseif (empty($blockbuyer) == 3) { ?>
                          <td><span class="badge badge-danger">บล็อค</span></td>
                        <?php } else { ?>
      ...
      <section class="content">
          ...
          <div class="col-md-6 col-12">
            ...
            <div class="card">
              <div class="card-header border-transparent">
                <h3 class="card-title"><i class="fas fa-users mr-2"></i>สินค้า</h3>
                ...
                <div class="table-responsive">
                  <table id="example3" class="table table-bordered table-striped">
                    ...
                    <tr>
                      ...
                      <th><?php echo $showproduct->number;?></th>
