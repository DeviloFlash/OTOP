    ...
    <div class="content-wrapper">
      ...
      <div class="d-flex justify-content-center">
        <div class="col-12 col-md-7">
            <div>
                <img src="<?php echo base_url('assest/img/otop')?>/<?php echo $readnews->img_news; ?>" class="d-block " alt="..." style="width: 100%;">
            </div>
        </div>
      </div>
        ...
        <div class="col-12 col-md-7">
          ...
          <div class="card">
            <div class="card-header border-transparent">
              <h3 class="card-title"><?php echo $readnews->topic_news;?></h3><br>
              <?php echo $readnews->data_news;?>
            ...
            <div class="card-body p-3">
              <div class="table-responsive">
                <p style="text-indent:3rem;"><?php echo $readnews->detel_news;?></p>
              </div>
              <!-- /.table-responsive -->
            </div>
          </div>
