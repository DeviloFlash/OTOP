...
<head>
  ...
  <title>OTOP | เว็บไซต์สำหรับสั่งซื้อสินค้า OTOP</title>
...
<body class="hold-transition sidebar-mini sidebar-collapse layout-fixed layout-navbar-fixed">
  ...
  <div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-light" style="background:	#ff851b;">
      ...
      <!-- SEARCH FORM -->
      <form class="form-inline ml-3 elevation-1" action="<?php echo base_url(); ?>Home" method="post">
    ...
    <div class="content-wrapper">
      ...
      <div class="content-header" style="padding:0px;" height="380">
        <div class="position-relative " style="height:305px; object-fit:cover;">
          <img src="<?php echo base_url(); ?>assest/dist/img/bg-main.png" class="card-img position-absolute" style="object-fit:cover;" height="300" alt="...">
          <div class="position-absolute col-12 col-sm-4" style=" margin:auto; height: 100px; background-color: #00000000; right:54%; top:0; left:0; bottom:50%;">
            <div class="card-body">
              <h1 class="text-light text-center" data-aos="fade-up" style="font-size: 3em; text-shadow: 2px 2px 4px #000;">OTOP นวัตวิถี</h1>
            </div>
          </div>
          <div class="position-absolute col-12 col-sm-4" style=" margin:auto; height: 100px; background-color: #00000000; right:48%; top:10%; left:0; bottom:0;">
            <h1 class="text-light text-center" data-aos="fade-up" style="text-shadow: 2px 2px 4px #000;">เว็บไซต์สำหรับซื้อขายสินค้า</h1>
          </div>
        </div>
      </div><!-- /.content-header -->
          ...
          <div class="row">
            ...
            <div class="col-lg-4 col-12">
              <div class="card" style="height:300px;">
                <h5 class="card-header text-white" style="background:#ff851b;"> <img class="mr-2" src="<?php echo base_url() ?>assest/dist/img/logo/logo-otop.png" style="width:20px; height:20px;"> ร้านค้าดีเด่น</h5>
                <div class="card-body overflow-auto p-1">

                  <div class="d-flex flex-nowrap mt-3">

                  <?php foreach ($showomembertopgood as $showgood) { ?>
                    <div class="col-lg-6 col-md-6 col-6 p-1">
                      <a href="<?php echo base_url(); ?>Store/Store_view/<?php echo $showgood->user_id; ?>">
                        <div class="card bg-white rounded-lg elevation-4" data-aos="zoom-in" style="width: 100%; height:100%;">
                          <div class="ribbon-wrapper ribbon-lg">
                            <div class="ribbon bg-danger">
                              ดีเด่น
                            </div>
                          </div>
                          <img src="<?php echo base_url() ?>assest/img/otop/1.jpg" class="card-img-top rounded-top" style="height:9rem;object-fit:cover;" alt="...">
                          <div class="card-body p-2">
                            <h5 class="card-title">ร้านคุณ <?php echo $showgood->display_name; ?></h5>
                          </div>
                        </div>
                      </a>
                    </div><!-- ส่วนกล่องสินค้า -->
              ...
              <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner">
                  <div class="carousel-item active">
                    <a href="#">
                      <img src="<?php echo base_url(); ?>assest/dist/img/news/news1.png" class="d-block " alt="..." style="width: 100%;">
                    </a>
                  </div>
                  <?php foreach ($shownewsmember as $shownews) { ?>
                  <div class="carousel-item">
                    <a href="#">
                      <img src="<?php echo base_url('assest/img/otop'); ?>/<?php echo $shownews->img_news; ?>" class="d-block " alt="..." style="width: 100%;">
                    </a>
                  </div>
                  <?php } ?>
    ...
    <footer class="main-footer">
      <strong>Copyright &copy; 2563 <a href="#">CPE-Project</a>.</strong> All rights
      reserved.
    </footer>
  </div>
  <!-- ./wrapper -->
