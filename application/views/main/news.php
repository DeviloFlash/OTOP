...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="card">
        <a href="<?php echo base_url('News/View/') .$shownews->id_news ?>" class="text-dark">
          <div class="card-body">
            <h5 class="card-title"><i class="fas fa-newspaper mr-2"></i><?php echo $shownews->topic_news; ?> : <?php echo $shownews->data_news; ?></h5>
          </div>
          <img class="card-img-bottom" src="<?php echo base_url('assest/img/otop'); ?>/<?php echo $shownews->img_news; ?>" alt="news">
        </a>
      </div>
      </div>
      </div>
