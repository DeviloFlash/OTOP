...
<ul class="navbar-nav ml-auto">
      ...
      <?php } ?>
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              <a href="https://www.the-qrcode-generator.com/scan" class="nav-link active">
  ...
  <div class="content-wrapper">
    ...
    <section class="content p-0">
      ...
      <iframe class="mt-2" src="https://www.the-qrcode-generator.com/scan" style="min-height:700px;" width="100%" frameborder="0"></iframe>
