...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <?php foreach ($showsell as $showreadsell) { ?>
      <div class="col-md-2 col-6 p-2">
        <a href="<?php echo base_url('Store/Store_view/') .$showreadsell->user_id; ; ?>">
        <!-- Widget: user widget style 1 -->
        <div class="card card-widget widget-user">

          <!-- Add the bg color to the header using any of the bg-* classes -->
          <div class="widget-user-header text-white"
               style="background: url('<?php echo base_url(); ?>assest/dist/img/shop1.png') center center;">
            <h3 class="widget-user-username text-right" style="text-shadow: 0 0 3px #000;"><?php echo $showreadsell->display_name;?></h3>
          </div>
          <div class="widget-user-image">
            <img class="img-circle" src="<?php echo base_url(); ?>assest/dist/img/user3-128x128.jpg" alt="User Avatar">
          </div>
          <div class="card-footer text-dark">
            <span>ร้าน : <?php echo $showreadsell->display_name;?></span>
          </div>
        </div>
        <!-- /.widget-user -->
        </a>
