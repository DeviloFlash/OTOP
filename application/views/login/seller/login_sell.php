...
<body class="hold-transition login-page" style="background-image:linear-gradient(rgba(0, 236, 255 ,0.45),rgba(0, 236, 255 ,0.45)), url(<?php echo base_url(); ?>assest/dist/img/bg-login.jpg);">
<div class="login-box">
  ...
  <div class="card rounded-lg elevation-4">
    ...
    <div class="col-3 mr-1">
      <a href="<?php echo base_url(); ?>Login2/Member" class="btn btn-app">
        <span class="badge bg-success"><?php echo count($showseller);?></span>
        <i class="fas fa-users"></i> ผู้ซื้อ
      </a>
    </div>
    <div class="col-3">
      <a href="<?php echo base_url(); ?>Login/Seller" class="btn btn-app bg-info">
        <span class="badge bg-danger"><?php echo count($showuser);?></span>
        <i class="fas fa-store"></i> ผู้ขาย
      </a>
    </div>
    </div>
    ...
    <div class="card-body login-card-body">
      ...
      <form action="<?php echo base_url(); ?>login/authen" method="post">
        ...
        <div class="row">
          ...
          <!-- /.col -->
          <div class="col-4">
            <button type="submit" class="btn btn-info btn-block">ตกลง</button>
          </div>
          <!-- /.col -->
        </div>
      </form>
      ...
      <p class="mb-0">
        <a href="<?php echo base_url(); ?>Register/Seller" class="text-center">สมัครสมาชิก</a>
      </p>
    </div>
    <!-- /.login-card-body -->
  </div>
