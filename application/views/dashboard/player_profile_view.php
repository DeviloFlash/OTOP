  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h1 class="m-0 text-dark">หน้าโปรไฟล์</h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
    ...
    <div class="content">
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-12">
            <h4>โปรไฟล์ของคุณ &nbsp;<a href="<?php echo base_url(); ?>dashboard/player_editprofile" class="btn btn-success">แก้ไข</a></h4>
            <hr>
          </div>
        </div>
                ...
                <div class="row">
                  <div class="col-sm-6 border-right">
                    <div class="description">
                      <h5>ชื่อ-นามสกุล</h5>
                      <p><?php echo $user->first_name.'&nbsp'.$user->last_name ;?></p>
                      ...
                      <h5>ประเทศ</h5>
                      <p><?php echo $user->user_country ;?></p>

                      <h5>รายละเอียดร้านค้า</h5>
                      <p><?php echo $user->detel_sell ;?></p>
                    </div>
                    <!-- /.description-block -->
                  </div>
                  <!-- /.col -->
                  <div class="col-sm-6">
                    <div class="description">
                      <h4>การติดต่ออื่นๆ</h4>
                      <h5>Facebook</h5>
                      <a href="<?php echo $user->facebook_url ;?>"><p><?php echo $user->facebook_url ;?></p></a>

                      <h5>Line</h5>
                      <a href="<?php echo $user->line_url ;?>"><p><?php echo $user->line_url ;?></p></a>
